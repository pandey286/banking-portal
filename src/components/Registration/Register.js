                  ...
                  <div className="col-xl-7">
                    <div className="card-body md-5 text-black">
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-6 mb-4">
                          <div className="form-outline">
                            <input type="text" id="form3Example1n" className="form-control form-control-lg" placeholder='Phone No.' required />
                          </div>
                        </div>
                        <div className="col-md-6 mb-4">
                          <div className="form-outline">
                            <input type="text" id="form3Example1n" className="form-control form-control-lg" placeholder='Alternate Phone No.' required />
                          </div>
                        </div>
                      </div>
                      ...
                      <div className='row'>
                        ...
                        <div className="form-outline col-md-6 mb-4">
                          <input type="text" id="form3Example8" className="form-control form-control-lg" placeholder='Account Type' />
                        </div>
                        <div className="form-outline col-md-6 mb-4">
                          <input type="text" id="form3Example8" className="form-control form-control-lg" placeholder='Branch Name' />
                        </div>
                        <div className="form-outline col-md-6 mb-4">
                          <input type="text" id="form3Example8" className="form-control form-control-lg" placeholder='IFSC Code' />
                        </div>
                        <div className="form-outline col-md-6 mb-4">
                          <input type="" id="form3Example8" className="form-control form-control-lg" placeholder='Branch Name' />
                        </div>
                        <div className="form-outline col-md-6 mb-4">
                          <input type="number" id="form3Example8" className="form-control form-control-lg" placeholder='Account Number' />
                        </div>
                      </div>
