...
const AccAndIfsc = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        const url = `http://localhost:8080/api/customers/user-data/${formData.userAccountNumber}/${formData.userIFSC}`;
        // console.log(url);
        try {
                ...
                <div id="content">
                    ...
                    <div className="row d-flex justify-content-center">
                        <div className="card col-md-4 me-3 ">
                            <div className="card-header fw-bold text-dark    fs-6 ">
                            ...
                            <div className="card-body d-flex row">
                                ...
                                <div className=" mb-2">
                                    <input type="text" id="ifsc_no" className="form-control col-6" placeholder='Enter ifsc code' name="userIFSC" onChange={handleChange} />
                                </div>
                                <div className="row d-flex justify-content-center">
                                    <button className="btn btn-outline-info shadow mb-3 col-md-4 mt-3" onClick={handleSubmit}> Search </button>
                                </div>
                            </div>
                        </div>
                    </div>
