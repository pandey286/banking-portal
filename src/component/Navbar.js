    ...
    return (
        <nav class="navbar navbar-nav navbar-expand-lg bg-warning">
            <div class="container-fluid">
                <Link className='navbar-brand fst-italic fs-3 m-' to='/'><BsBank /> CSB</Link>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-lg-0">
                        <li class="nav-item">
                            <NavLink className="nav-link active fs-5" to="/home">Home</NavLink>
                        </li>
                        <li class="nav-item">
                    ...
                    <button class="btn btn-primary" type="button"><NavLink className="nav-link fs-5" to="/login">Login</NavLink></button>
                </div>
            </div>
        </nav>
    );
